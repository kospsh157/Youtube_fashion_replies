...
stopwords = ['츠', '진행', '탑', '즈', '나중', '끈', '즈 ', '짐 ', '이야기 ', '츠 ', '당장 ', '슈', '나중 ', '진행 ', '하트 ', '스타일링 ', '일본 ', '지퍼 ',
             '슈 ', '에스 ', '카드 ', '세인 ', '끌 ', '이야기 ', '에스 ', '끈 ', '메종 ', '길이 ', '참여', '알파카', '제목', '트렌드', '완성', '사이', '포기',
             '장바구니', '국내', '노력', '감기',
             '예스', '효과', '세탁', '턱', '열', '얄', '일반', '보통', '연출', '블랭크', '주름', '연출', '노드', '유익', '천', '발매', '스탈', '발매', '신상',
             '쇼핑몰', '스트라이프', '수능', '이것', '걸까요', '브이', '입문', '스탠다드', '제니', '종류', '검색', '앱', '르소', '여러분', '내가', '너가', '얼마나',
             '얼', '폼', '품', '피', '시크', '공홈',
             ...
             '힙', '향', '혜인', '브렌', '감성', '코어', '쿠어', '사향', '왕발', '다리', '지드래곤', '오디션', '측정기', '주세', '공부', '재미', '웩', '이해',
             '리스트', '세계', '세미', '메종', '사고', '스타일링', '스타일', '사건', '주식', '코인', '급증', '너도', '나도', '유행', '인기', '패션', '개', '나',
             '소', '음', '응', '야', '뭐', '이걸', '붕괴', '대대', '색깔'
             ]
tagger = MeCab()
