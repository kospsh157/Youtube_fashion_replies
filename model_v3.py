...
# 유니크한 아이템 생성
items = [
    '티셔츠', '스웨터', '블라우스', '폴로셔츠', '셔츠', '후드티', '카디건', '니트', ' 셔츠', '조끼',
    '드레스 셔츠', '목 폴라', ' 티', '기모 티', '옥스포츠드 셔츠', '후드 티', '집업 후드', '폴로 셔츠', '크롭탑', '남방',
    '하프 폴라', '후드', '짧은 티', '긴 팔', '상의', '오버사이즈 셔츠', '데님 셔츠', '탱크탑', '반 팔', '린넨 셔츠',
    '기모 후드', '스웨터', '블라우스', '폴로 셔츠', '셔츠', '후드 티', '하프 집업', '와이셔츠', '탑', '나시',
    '드레스셔츠', '목폴라', '티', '기본 티', '런닝구', '후드 티', '집업후드', '폴로셔츠', '크롭 탑', '스웻터',
    '하프폴라', '후디', '짧은티', '긴팔', '상의', '저지', '데님셔츠', '탱크 탑', '반팔', '린넨셔츠',
    ...
    '카고', '스커트', '치마', '테니스치마', '가죽바지', '조거', '스키니', ' 바지', '드레스팬츠', '레더팬츠',
    ...
    '코트', '트렌치코트', '패딩재킷', '데님재킷', '가죽자켓', '블레이저', '파카', '바람 막이', '레인코트', '가을 야상',
    '아우터', '덕 다운', '블루종', '청 자켓', '청 재킷', '캐시미어코트', '블레이저', '벨벳재킷', '재킷', '퀼트 재킷',
    '청 자켓', '롱트렌치코트', '데님 재킷', '항공점퍼', '레더재킷', '트러커재킷', '스키재킷', '맥시코트', '롱코트', '롱패딩',

    '런닝화', '하이힐', '킬 힐', '샌들', '가죽 로퍼', '스니커즈', '플랫 슈즈', '워커', '슬립온', '신발',
    '컨버스', '나이키 신발', '아디다스 신발', '퓨마 신발', '군화', '부츠', '컴뱃 부츠', '펌프스', '스트랩 샌들', '플랫폼 슈즈',
    '글래디에이터 샌들', '짚신', '모카신', '옥스퍼드 슈즈', '메리제인 슈즈', '뉴발란스 신발', '장화', '크록스', '슬리퍼', '구두',
    '로퍼', '하이 힐', '롱부츠', '샌들', '케쥬얼 구두', '스니커즈', '플랫슈즈', '워커', '슬립 온', '쪼리',
    '컨버스', '나이키신발', '아디다스신발', '퓨마신발', '군화', '가죽 구두', '컴뱃부츠', '펌프스', '스트랩샌들', '플랫폼슈즈',
    '나막신', '에스파드리유', '모카신', '옥스퍼드슈즈', '메리제인슈즈', '뉴발 신발', '운동화', '크록스', '슬리퍼', '구두',

    '목걸이', ' 귀걸이', '팔찌', ' 시계', '반지', '헤어밴드', '선글라스', '스카프', '캡', '벨트',
    '악세사리', '악세', '브로치', '커프스', '토트백', '클러치', '백팩', '핸드백', '목도리', '헤어클립',
    '마스크', '양말', '콘택트 렌즈', ' 렌즈', '안경', '가방', '헤드폰', '헤어 핀', '컨텍트 렌즈', '넥타이',
    ' 목걸이', '귀걸이', ' 팔찌', '시계', ' 반지', '헤어 밴드', ' 선글라스', '빽', '모자', '가죽 벨트',
    '타투', '악새', '백', '패딩 목도리', '토트백', '클러치', '백팩', ' 핸드백', '털 장갑', '헤어 클립',
    ' 마스크', ' 양말', '콘택트렌즈', '렌즈', '네일 아트', '가방', '벙어리 장갑', '헤어핀', '컨텍트렌즈', '넥 타이',

    '책', '볼펜', '노트북', '컵', '휴대폰', '키보드', '마우스', '모니터', '가방', '의자',
    '물건', '안테나', '자동차', '노래', '음식', '쓰레기', '테이블', '스피커', '우산', '램프',
    '카메라', '사람', '플랜터', '빌딩', '땅', '문신', '패션', '친구', '유튜브', '유튜버',
    '졸라', '존나', '인사', '방장', '팀원', '왜', '인사', '안녕하세요', 'ㅋㅋ', 'ㅋ',
    '칼라', '쿠션', '야외', 'ㅋㅋㅋ', '인터넷', '조금', '패션', '모델', '예쁘', '이쁘',
...
model = FashionClassifier(len(vocab)+1, 150, 6)  # 임베딩 차원 10, 분류 6개
